...
\title{Using Force Vectors} \author{Ahmed Saad Sabit} \date{\today} 
...
\begin{frame}{Day 1} \titlepage  \end{frame}
...
\begin{frame}{0.2 Trig} Because of some ratio of the right angled triangle we
    ...
    \[ \text{adjancent} = \text{hypotenuse}\  \cos \theta \]
...
\begin{frame}
    ...
    \begin{tikzpicture}
        ...
        \draw[-stealth, green](3,2) -- (1,3) node[midway,above]{$\vec c= \vec b - \vec a$};
\end{tikzpicture} $\vec a + \vec c = b \to \vec c = \vec b - \vec a$}
\end{frame}
